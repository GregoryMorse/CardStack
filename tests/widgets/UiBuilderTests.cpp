...
private slots:
    ...
    void sortsAvailableReportsByTypeThenDescriptionAndPreservesSourceIndex()
    {
        ...
        QCOMPARE(reports->item(0)->data(UiBuilder::ReportTypeRole).toString(), QStringLiteral("Card"));
        QCOMPARE(reports->item(0)->data(UiBuilder::ReportDescriptionRole).toString(), QStringLiteral("Alpha"));
        QCOMPARE(reports->item(1)->data(UiBuilder::ReportTypeRole).toString(), QStringLiteral("Card"));
        QCOMPARE(reports->item(1)->data(UiBuilder::ReportDescriptionRole).toString(), QStringLiteral("Beta"));
        QCOMPARE(reports->item(2)->data(UiBuilder::ReportTypeRole).toString(), QStringLiteral("Label"));
        QCOMPARE(reports->item(2)->data(UiBuilder::ReportDescriptionRole).toString(), QStringLiteral("Address"));
        QCOMPARE(reports->item(3)->data(UiBuilder::ReportTypeRole).toString(), QStringLiteral("Report"));
        QCOMPARE(reports->item(3)->data(UiBuilder::ReportDescriptionRole).toString(), QStringLiteral("Alpha"));
        QCOMPARE(reports->item(4)->data(UiBuilder::ReportTypeRole).toString(), QStringLiteral("Report"));
        QCOMPARE(reports->item(4)->data(UiBuilder::ReportDescriptionRole).toString(), QStringLiteral("Zulu"));
